...
class FlowLogParser:
    def parse_protocol_number(self):
        """
    ...
    def output_flow_log_result(self):
        """
    ...
    def output_port_protocol_result(self):
        """
    ...
    def run(self):
        ...
        self.parse_protocol_number()
        self.parse_lookup()
        self.parse_flow_log()
        # write the results to the output files
        self.output_flow_log_result()
        self.output_port_protocol_result()
